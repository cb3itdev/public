...
::grab 7zr
powershell $7zrexe = "(Invoke-WebRequest -Uri 'https://7-zip.org/download.html' -UseBasicParsing).Links.href | Where-Object {$_ -match '.exe$'}"; Invoke-WebRequest -Uri $7zrexe -OutFile C:\SWSetup\7zr.exe
timeout /t 2 > NUL
